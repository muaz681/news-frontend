        ...
        <div class="row border-news">
            ...
            <div class="col-md-2 col-lg-2 col-sm-12 col-12 border-col">
                <div class="footer-left">
                    <h2>সংস্করণ</h2>
                    <ul>
                        <li class="footer-li-active"><a href="{{ url('/') }}">বাংলা</a></li>
                        <li class="footer-li"><a href="https://voicetv.tv/">English</a></li>
                        <li class="footer-li"><a href="{{ url('/archive') }}">আর্কাইভ</a></li>
                    </ul>
                </div>
            </div>
            {{-- Footer 2nd part --}}
            <div class="col-md-5 col-lg-5 col-sm-12 col-12 border-col">
                <div class="footer-middle row">
                    <div class="col-md-6 col-lg-6 col-sm-6 col-6">
                        <ul>
                            <li class="footer-list"><a href="{{ url('/about-us') }}">আমাদের সম্পর্কে</a></li>
                            ...
                            {{-- <li class="footer-list"><a href="{{ url('/category/video-news') }}">ভিডিও সংবাদ</a></li> --}}
                        </ul>
                    </div>
                    <div class="col-md-6 col-lg-6 col-sm-6 col-6">
                        <ul>
                            <li class="footer-list"><a href="https://shaplamedia.com/">শাপলা মিডিয়া</a></li>
                            <li class="footer-list"><a href="https://cinebaz.com/">সিনেবাজ</a></li>

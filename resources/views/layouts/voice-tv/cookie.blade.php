        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-12">
                    <h1>Cookie Policy for Voice Television</h1>
                    <p>This is the Cookie Policy for Voice Television, accessible from https://voicetv.tv</p>
                    <p>
                    ...
                    <ul>
                        <li>By visiting this link: https://voicetv.tv</li>
                        <li data-v-5b29b9e2="">By Phone: +৮৮ ০২ ৯৩৩৮৫৩০</li>
                    </ul>
                </div>
            </div>
        </div>
